                    ...
                    <h4>
                        <asp:HyperLink ID="lnkShoppingBasket" runat="server" NavigateUrl="~/Basket.aspx">
                            <asp:Literal ID="litShoppingBasketTitle" runat="server" Text="<%$ Resources:Basket, PageTitle_ShoppingBasket  %>"
                                EnableViewState="false" /></asp:HyperLink></h4>
                    <div class="box">
                        <div id="numberofitems">
                            <asp:Literal ID="litNumberOfItemsTitle" runat="server" Text="<%$ Resources:Kartris, ContentText_MinibasketNumberOfItems  %>"
                                EnableViewState="false" />
                            <strong>
                                <asp:Literal ID="litNumberOfItems" runat="server" /></strong>
                        </div>
                                    ...
                                    <li id="minibasket_promotions">
                                        <asp:HyperLink ID="lnkMiniBasketPromotions" runat="server">
                                            <asp:Literal ID="litPromotions" runat="server" Text='<%$Resources:Kartris,SubHeading_Promotions%>'
                                                EnableViewState="false"></asp:Literal></asp:HyperLink>
                                    </li>
                                </asp:PlaceHolder>
                                ...
                                <asp:PlaceHolder ID="phdMiniBasketCustomerDiscount" runat="server">
                                    <li id="minibasket_customerdiscount">
                                        <asp:HyperLink ID="lnkMiniBasketCustomerDiscount" runat="server">
                                            <asp:Literal ID="litCustomerDiscount" runat="server" Text='<%$Resources:Kartris,ContentText_CustomerDiscount%>'></asp:Literal></asp:HyperLink>
                                    </li>
                                </asp:PlaceHolder>
                                <% End If%>
                                <li id="totals">
                                    <asp:PlaceHolder ID="phdMiniBasketTax" runat="server">
                                        <div id="minibasket_total_1">
                                            <asp:Literal ID="litMiniBasketTax1" runat="server" /></div>
                                        <div id="minibasket_total_2">
                                            <asp:Literal ID="litMiniBasketTax2" runat="server" /></div>
