#---------------------------------------------------------------------
# $Header: /Perl/OlleDB/t/Z_threads.t 8     08-03-23 23:28 Sommar $
#
...
sub get_data {
    ...
    $select = "SELECT convert(datetime, '2005-03-23 19:23') UNION " .
              "SELECT convert(datetime, '1962-09-12 03:25') ORDER BY 1";
